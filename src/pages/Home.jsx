...
const Home = () => {
    return (
        <>
            ...
            {/* Pricing Section CTA */}
            <section className="py-40 px-6 max-w-7xl mx-auto bg-neutral-50 border-y border-neutral-200">
                <div className="text-center">
                    <h2 className="text-6xl font-display font-bold uppercase tracking-tighter mb-8">Deployment Costs</h2>
                    <p className="text-xl text-neutral-500 font-light max-w-2xl mx-auto mb-12">
                        Transparent resource allocation. Choose a pre-configured module or use our calculator for custom requirements.
                    </p>
                    <a href="#/pricing" className="inline-block px-12 py-5 bg-black text-white font-bold uppercase tracking-[0.2em] text-sm hover:scale-105 transition-transform shadow-2xl">
                        View Rate Card & Calculator
                    </a>
                </div>
            </section>
